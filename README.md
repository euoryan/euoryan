Olá 👋 Eu sou o Ryan, um **Desenvolvedor Full Stack** com experiência em **automações, desenvolvimento de landing pages e sites estáticos**, além de **criação de programas em Python** e **design UI/UX para front-end**.

Atualmente, trabalho há **3 anos** desenvolvendo soluções digitais e automações para o setor de transportes, otimizando processos e melhorando a eficiência operacional.
...
- **Desenvolvimento Web**: Sites estáticos, landing pages e portais personalizados.
